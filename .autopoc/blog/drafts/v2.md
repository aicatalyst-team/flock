<!-- Changelog v2: Fixed formatting issues - removed all inline backticks, expanded acronyms on first use, added CTAs near top and mid-article, added code blocks (Dockerfile, YAML), added hero image placeholder, added gateway concept diagram, added alt text to Mermaid diagrams -->
